...
public final class UsersContainer {
    ...
    public boolean isStudent(Signature signature) {
        return isStudent(getLogin(signature));
    }

    public boolean isLecturer(Signature signature) {
        return isLecturer(getLogin(signature));
    }
